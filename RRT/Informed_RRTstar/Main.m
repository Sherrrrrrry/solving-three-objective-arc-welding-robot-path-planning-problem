 ...
 for i = 1:num_of_runs
     ...
     if ( (norm(start_node(1:dim)-end_node(1:dim))<segmentLength )...
         ...
         if samples >0
             ...
             flag = 0;
             for j = 1:samples
                 [tree,flag,cbest] = extendTree(tree,end_node,segmentLength,radius,world,flag,dim,cbest);
...
%                  pause(0.1);
     ...
     time = [time; run_time];      avg_path = [avg_path; pathlength];      n_its = [n_its; its];
